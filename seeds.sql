INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident) VALUES (1, 'HTML/CSS/Javascript', 'To know and contrast the roles of HTML/CSS and javascript','https://blog.hubspot.com/marketing/web-design-html-css-javascript#:~:text=HTML%20provides%20the%20basic%20structure,the%20behavior%20of%20different%20elements.');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'HTML/CSS/Javascript', 'Re-create a website using common HTML elements (h1, h2, ul, li, div...)','https://www.digitalocean.com/community/tutorial_series/how-to-build-a-website-with-html','https://www.proprofs.com/quiz-school/playquiz/?title=frontpage-quiz-2');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'HTML/CSS/Javascript', 'Describe what the DOM is and why it is useful','https://developer.mozilla.org/en-US/docs/Web/API/Document_Object_Model/Introduction','https://www.codeguage.com/courses/js/html-dom-quiz');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'HTML/CSS/Javascript', 'Style an element using CSS','https://flukeout.github.io/','https://www.w3schools.com/quiztest/quiztest.asp?qtest=CSS');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'HTML/CSS/Javascript', 'Predict the outcome of CSS based on the rules of CSS specificity','https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity','https://mjswensen.github.io/css-power-ups/the-cascade-and-specificity/specificity-quiz/');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'HTML/CSS/Javascript', 'Be able to use flexbox to change the layout of a HTML element','https://flexboxfroggy.com/','https://kaitlynbro.github.io/flexbox-quiz/' );
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'HTML/CSS/Javascript', 'To know how to manipulate the DOM using JavaScript','https://www.youtube.com/watch?v=wiozYyXQEVk','https://kaitlynbro.github.io/flexbox-quiz/' );
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'Javascript', 'Can Identify different data types in JavaScript (string, number, array and objects)','https://www.programiz.com/javascript/data-types','https://learn.co/lessons/javascript-data-types-quiz');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident) VALUES (1, 'Javascript', 'Explain the difference between console.log() and return in Javascript','https://quick-adviser.com/what-is-the-difference-between-console-log-and-return-in-javascript/');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident) VALUES (1, 'Javascript', 'Be able to use conditional statement for control flow','https://www.codecademy.com/learn/introduction-to-javascript/modules/learn-javascript-control-flow/cheatsheet');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident) VALUES (1, 'React', 'To know the problem that front end framework are trying to solve','https://reactjs.org/docs/react-component.html');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident) VALUES (1, 'React', 'Understand what JSX is and how it is different to HTML and Javascript','https://reactjs.org/docs/react-component.html');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident) VALUES (1, 'React', "Be able to handle events in React",'https://reactjs.org/docs/react-component.html');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident) VALUES (1, 'React', "Be able to use ternary operators in React and use it to apply conditional rendering",'https://reactjs.org/docs/react-component.html');
