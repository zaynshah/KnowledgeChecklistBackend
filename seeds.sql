INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'HTML/CSS', 'Understand what parent and child is');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective, not_confident, confident) VALUES (1, 'HTML/CSS', 'Understand how to use flexbox','https://flexboxfroggy.com/','https://kaitlynbro.github.io/flexbox-quiz/' );
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'Javascript', 'Be able to link a Javascript file in your project');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'Javascript', 'Be able to do a console.log()');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'React', 'Be able to pass props');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'React', 'Be able to handle events in React');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'React', 'Be able to use ternary operators in React');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'React', 'Be able to use conditional rendering');
...
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'React', 'Be able to update state');
INSERT INTO learning_objectives(cohort_id, topic, learning_objective) VALUES (1, 'React', 'Understand what hooks are');
